...
//            }
    ...
    public void test() {
        ...
        List<Integer> blue100 = Lists.newArrayList(
                ...
                2, 4, 15, 8, 15, 1, 2, 12, 14, 3, 7, 14, 8, 4, 5, 14, 1, 8, 7, 8, 10, 4
        );

        double[][] three = twoBlueService.transfor(blue100).getProbability();
        ...
        double[][] five = fourBlueService.transfor(blue100).getProbability();
        ...
        double[][] eight = eightBlueService.transfor(blue100).getProbability();
        ...
        double[][] six10 = six10BlueService.transfor(blue100).getProbability();
